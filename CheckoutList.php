...
<div class="product-container checkout-page">
	<div class="header checkout-header">
		...
		<button onclick="window.location.href='cart.php'" class="btn-add" type="button">Back To Cart</button>
	</div>
	...
	<div class="checkout-card">
		...
		<div class="checkout-section payment-box">
			...
			<form class="payment-method-form" action="payment_list.php" method="post" enctype="multipart/form-data">
				...
				<div class="payment_detail" style="display: none;">
					...
					<img src="./ew.jpg" alt="E-wallet QR Code" width="400" height=500 />
					<br>
